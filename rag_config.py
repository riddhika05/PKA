...
FILE_SPLITTER_FACTORY: Dict[str, Any] = {
    ...
    ".js": lambda: get_default_splitter(),
    ...
    ".cpp": lambda: get_default_splitter(),
    ".c": lambda: get_code_splitter("c"),
    ".jsx": lambda: get_default_splitter(),
    ".tsx": lambda: get_code_splitter("typescript"),
    ".html": lambda: get_code_splitter("html"),
    ".css": lambda:get_default_splitter(),
    ".go": lambda:get_default_splitter(),
    ".rb": lambda:get_default_splitter(),
    ".vb": lambda:get_default_splitter(),
    ".pl": lambda:get_default_splitter(),
    ".h": lambda:get_code_splitter("c"),
    ".hpp": lambda:get_default_splitter(),
    ".sh": lambda:get_default_splitter(),
    ".swift": lambda:get_default_splitter(),
    ".kt": lambda:get_default_splitter(),
